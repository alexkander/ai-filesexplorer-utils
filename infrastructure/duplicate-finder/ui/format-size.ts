 ...
 * local copy rather than importing another tool's copy — this feature slice
 * stays free of cross-tool imports (the only intentional exception is the
 * shared `scanning` module). */
